        ...
        <nav className='flex justify-between items-center fixed z-10 top-0 w-full py-5 px-8 text-sm font-light fondo '>
            <ul className='flex items-center gap-3'>
                <li className='font-semibold text-lg'>
                    <NavLink to='/' onClick={() => context.setSearchByCategory()}>Apni Dukaan</NavLink>
                </li>
                <li>
                    <NavLink
                        to='/'
                ...
                <li>
                    <NavLink
                        to='/laptops'
                        onClick={() => context.setSearchByCategory('Local')}
                        className={({ isActive }) => isActive ? activeStyle : undefined}
                    >
                       <b className='text-5sm'>Local</b> 
                ...
                <li>
                    <NavLink
                        to='/tablets'
                        onClick={() => context.setSearchByCategory('Medicine')}
                        className={({ isActive }) => isActive ? activeStyle : undefined}
                    >
                        <b>Medicine</b>
                    </NavLink>
